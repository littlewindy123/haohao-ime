...
data class GeneralStyle(
    ...
    val compactCandidateTextSize: Float?,
    val compactTranslationTextSize: Float?,
    val compactPhoneticTextSize: Float?,
    ...
    companion object {
        fun decode(node: Node): GeneralStyle = GeneralStyle(
            ...
            compactCandidateTextSize = node["compact_candidate_text_size"]?.float,
            compactTranslationTextSize = node["compact_translation_text_size"]?.float,
            compactPhoneticTextSize = node["compact_phonetic_text_size"]?.float,
            ...
            keyCapHeight = node["key_cap_height"]?.int ?: 0,
