...
- 收藏不自动加入学习；轻复习和每日计划共享进度，支持持久化的单步评分撤销。Room 版本 3 保留完整升级路径，英文展示大小写与去重键分开，具体规则见[个人词本说明](docs/business/personal-words.md)。
- 清空最近输入会保留收藏和学习进度，清空全部需明确确认。英文发音只选择系统已安装且无需网络的英语音色，优先美式英语；错误提供重试和系统语音设置入口，不自动下载音库。
